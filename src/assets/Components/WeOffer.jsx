    ...
    details: [
      {
        title: "Classes 5-8",
        description:
          "Building strong foundations in Mathematics, Science, and Language with interactive learning methods.",
      },
      {
        title: "Classes 9-10",
        description:
          "Focused preparation for board exams with rigorous practice sessions and conceptual clarity.",
      },
      {
        title: "Classes 11-12",
        description:
          "Specialized coaching in Science (Physics, Chemistry, Biology, Mathematics) and Commerce streams for board exams and competitive exams.",
      },
    ],
  },
  {
    ...
    details: [
      {
        title: "Banking Exams",
        description:
          "Coaching for IBPS, SBI PO/Clerk, RBI exams with a focus on Quantitative Aptitude, Reasoning, English, and General Awareness.",
      },
      {
        title: "Civil Services",
        description:
          "Preparation for UPSC, State PSC exams with specialized modules in General Studies, CSAT, and optional subjects.",
      },
      {
        title: "Railway Exams",
        description:
          "Coaching for RRB NTPC, RRB Group D, and other railway exams with focused training on relevant subjects.",
      },
      {
        title: "SSC Exams",
        description:
          "Training for SSC CGL, SSC CHSL, and other exams with comprehensive coverage of syllabus and extensive practice sessions.",
      },
    ],
  },
];
...
=======
    ...
    <div className="pb-12 bg-white bg-[radial-gradient(ellipse_40%_70%_at_0%_-10%,rgba(120,119,198,0.3),rgba(255,255,255,0))] ">
            ...
            <div className="App">
              {headText.map((el, i) => (
                <motion.span
                  ...
                  key={i}
                >
                  <span className="font-semibold  text-zinc-700 text-[6vh] sm:text-[4.5vw]  hover:text-slate-600 hover:cursor-pointer">
                    {" "}
                    {el}{" "}
                  </span>
                </motion.span>
      ...
      {/* courses section  */}
      <div
        className="flex flex-col justify-center sm:flex-col w-full sm:px-52 sm:-space-y-32"
        style={{
      ...
      ${
        index % 2 === 0
          ? "border-b-2 border-r-[1px]"
          : "border-t-2 border-l-[1px] "
      } border-slate-400  
